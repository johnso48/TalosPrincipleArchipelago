...
MAIN_LOCATIONS: typing.Dict[str, LocData] = {
    ...
    "World B3 Red L":      LocData(BASE_ID + 43, REGION_WORLD_B),
    "World B4 Red T 1":    LocData(BASE_ID + 44, REGION_WORLD_B),
    "World B4 Red T 2":    LocData(BASE_ID + 45, REGION_WORLD_B),
    "World B4 Green T":    LocData(BASE_ID + 46, REGION_WORLD_B),
    "World B4 Green J":    LocData(BASE_ID + 47, REGION_WORLD_B),
    "World B4 Red L 1":    LocData(BASE_ID + 48, REGION_WORLD_B),
    "World B4 Red L 2":    LocData(BASE_ID + 49, REGION_WORLD_B),
    "World B5 Red I":      LocData(BASE_ID + 50, REGION_WORLD_B),
    "World B5 Red L":      LocData(BASE_ID + 51, REGION_WORLD_B),
    "World B5 Red S":      LocData(BASE_ID + 52, REGION_WORLD_B),
    "World B5 Green J":    LocData(BASE_ID + 53, REGION_WORLD_B),
    "World B5 Red Z":      LocData(BASE_ID + 54, REGION_WORLD_B),
    "World B6 Red I":      LocData(BASE_ID + 55, REGION_WORLD_B),
    "World B6 Golden T":   LocData(BASE_ID + 56, REGION_WORLD_B),
    "World B6 Golden L":   LocData(BASE_ID + 57, REGION_WORLD_B),
    "World B7 Red J":      LocData(BASE_ID + 58, REGION_WORLD_B),
    "World B7 Red I":      LocData(BASE_ID + 59, REGION_WORLD_B),
    "World B7 Golden O":   LocData(BASE_ID + 60, REGION_WORLD_B),
    "World B7 Golden I":   LocData(BASE_ID + 61, REGION_WORLD_B),
    # World C1-C7 (27) - behind C Gate
    "World C1 Red Z":      LocData(BASE_ID + 62, REGION_WORLD_C),
    "World C1 Red J":      LocData(BASE_ID + 63, REGION_WORLD_C),
    "World C1 Red I":      LocData(BASE_ID + 64, REGION_WORLD_C),
    "World C1 Red T":      LocData(BASE_ID + 65, REGION_WORLD_C),
    "World C2 Red Z":      LocData(BASE_ID + 66, REGION_WORLD_C),
    "World C2 Red O":      LocData(BASE_ID + 67, REGION_WORLD_C),
    "World C2 Red T":      LocData(BASE_ID + 68, REGION_WORLD_C),
    "World C2 Red S":      LocData(BASE_ID + 69, REGION_WORLD_C),
    "World C3 Red J":      LocData(BASE_ID + 70, REGION_WORLD_C),
    "World C3 Red O":      LocData(BASE_ID + 71, REGION_WORLD_C),
    "World C3 Red Z":      LocData(BASE_ID + 72, REGION_WORLD_C),
    "World C3 Red T":      LocData(BASE_ID + 73, REGION_WORLD_C),
    "World C4 Red T 1":    LocData(BASE_ID + 74, REGION_WORLD_C),
    "World C4 Red I":      LocData(BASE_ID + 75, REGION_WORLD_C),
    "World C4 Red S":      LocData(BASE_ID + 76, REGION_WORLD_C),
    "World C4 Red T 2":    LocData(BASE_ID + 77, REGION_WORLD_C),
    "World C5 Red I":      LocData(BASE_ID + 78, REGION_WORLD_C),
    "World C5 Red O 1":    LocData(BASE_ID + 79, REGION_WORLD_C),
    "World C5 Red O 2":    LocData(BASE_ID + 80, REGION_WORLD_C),
    "World C5 Red T":      LocData(BASE_ID + 81, REGION_WORLD_C),
    "World C6 Red S":      LocData(BASE_ID + 82, REGION_WORLD_C),
    "World C6 Red J":      LocData(BASE_ID + 83, REGION_WORLD_C),
    "World C6 Red O":      LocData(BASE_ID + 84, REGION_WORLD_C),
    "World C7 Red T 1":    LocData(BASE_ID + 85, REGION_WORLD_C),
    "World C7 Red O":      LocData(BASE_ID + 86, REGION_WORLD_C),
    "World C7 Red T 2":    LocData(BASE_ID + 87, REGION_WORLD_C),
    "World C7 Red L":      LocData(BASE_ID + 88, REGION_WORLD_C),
}
